...
echo "${COLOR_CYAN}${BOLD}│          Welcome to Kailash Parmar Cloud Tutorial            │${COLOR_RESET}"
echo "${COLOR_CYAN}${BOLD}└──────────────────────────────────────────────────────────────┘${COLOR_RESET}"
echo
...
echo "${COLOR_CYAN}${BOLD}https://www.youtube.com/@kailash_parmar${COLOR_RESET}"
echo "${COLOR_MAGENTA}${BOLD}Kailash Parmar - Cloud Solutions Expert${COLOR_RESET}"
echo
