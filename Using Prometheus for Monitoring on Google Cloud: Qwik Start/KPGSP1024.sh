...
# Expertly crafted by Kailash parmar
...
echo "${BG_BLUE}${BOLD}${WHITE}       WELCOME TO KAILASH PARMAR TUTORIALS        ${RESET}"
echo "${BG_BLUE}${BOLD}${WHITE}==================================================${RESET}"
echo ""
echo "${CYAN}${BOLD}⚡ Expertly crafted by KAILASH PARMAR${RESET}"
