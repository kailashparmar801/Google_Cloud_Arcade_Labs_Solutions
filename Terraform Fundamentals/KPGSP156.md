...
```
curl -LO raw.githubusercontent.com/kailashparmar801/Google_Cloud_Arcade_Labs_Solutions/master/Terraform%20Fundamentals/KPGSP156.sh
sudo chmod +x KPGSP156.sh
./KPGSP156.sh
```
