...
```
curl -LO raw.githubusercontent.com/kailashparmar801/Google_Cloud_Arcade_Labs_Solutions/master/Web%20Security%20Scanner%3A%20Qwik%20Start/KPGSP112.sh
sudo chmod +x KPGSP112.sh
./KPGSP112.sh
```
