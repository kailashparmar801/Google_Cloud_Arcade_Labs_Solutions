...
```
curl -LO raw.githubusercontent.com/kailashparmar801/Google_Cloud_Arcade_Labs_Solutions/master/Managing%20Deployments%20Using%20Kubernetes%20Engine/KPGSP053.sh
sudo chmod +x KPGSP053.sh
./KPGSP053.sh
```
