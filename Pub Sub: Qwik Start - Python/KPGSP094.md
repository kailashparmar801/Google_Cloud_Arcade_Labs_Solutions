...
```
curl -LO raw.githubusercontent.com/kailashparmar801/Google_Cloud_Arcade_Labs_Solutions/master/Pub%20Sub%3A%20Qwik%20Start%20-%20Python/KPGSP094.sh
sudo chmod +x KPGSP094.sh
./tKPGSP094.sh
```
