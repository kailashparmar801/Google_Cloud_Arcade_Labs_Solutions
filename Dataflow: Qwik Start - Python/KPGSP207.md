...
```
curl -LO raw.githubusercontent.com/kailashparmar801/Google_Cloud_Arcade_Labs_Solutions/master/Dataflow%3A%20Qwik%20Start%20-%20Python/KPGSP207.sh
sudo chmod +x KPGSP207.sh
./KPGSP207.sh
```
